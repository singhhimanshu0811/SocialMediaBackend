...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductDTO addProduct(ProductDTO productDTO, Long categoryId) {
        ...
        //we will get product name and id and discount and price from the user in product object
        Category category = categoryRepository.findById(categoryId).
                orElseThrow(() -> new ResourceNotFoundException("Category", "categoryId", categoryId));
        //we need to see if that product is present in category before or not

//        boolean isProductInCategory = false;
//        isProductInCategory = category.getProducts().forEach(productInstance -> productInstance.getProductName().equals(modelMapper.map(productDTO, Product.class).getProductName()) ? false);
        //you cant check with forEach, as it just iterates.
        //use anyMatch, which sees if any condition is true inside the anyMatch brakcet
